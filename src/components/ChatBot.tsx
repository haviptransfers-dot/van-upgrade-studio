      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-24 left-4 right-4 sm:left-6 sm:right-auto sm:w-[380px] z-50 bg-card border border-primary/30 rounded-lg shadow-2xl flex flex-col overflow-hidden"
